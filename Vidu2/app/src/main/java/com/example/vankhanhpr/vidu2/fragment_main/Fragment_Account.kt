...
import kotlinx.android.synthetic.main.fragment_manager_account.*
...
class Fragment_Account : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        var inval: Array<String> = arrayOf(Json.AppLoginID)//........... gửi dữ liệu kiểm tra thông tin khách hàng b1
        call.CallEmit(AllValue.workername_get_customer, AllValue.servicename_get_customer!!,inval, AllValue.get_info_customer!!)
        ...
        tab_logout1.setOnClickListener { //............ chuyển đến formLogin B1_logout
